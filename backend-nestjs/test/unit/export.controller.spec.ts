...
describe('ExportController', () => {
  ...
  describe('参数传递', () => {
    ...
    it('不传任何筛选参数时使用默认值', async () => {
      ...
      expect(mockRepoService.findPage).toHaveBeenCalledWith(expect.objectContaining({
        page: 1, size: 10,
        keyword: '', language: '',
  ...
  describe('Markdown 生成', () => {
    ...
    it('应包含时间范围信息', async () => {
      ...
      await controller.exportMd({
        dateField: 'starred_at', startDate: '2024-01-01', endDate: '2024-12-31',
        maxCount: '10',
      }, res)
    ...
    it('单个仓库导出格式正确', async () => {
      mockRepoService.findPage.mockResolvedValue(mockFindPageResult([
        {
          id: BigInt(1),
      ...
      mockRepoService.findPage.mockResolvedValue(mockFindPageResult([
        {
          id: BigInt(1),
          fullName: 'test/repo',
          starsCount: 1, forksCount: 0, language: null,
          htmlUrl: 'url', homepage: null,
          descriptionCn: null, description: 'original desc',
          readmeCn: null, readmeOriginal: null,
        },
      ], 1))
      const res = createMockResponse()
      ...
      mockRepoService.findPage.mockResolvedValue(mockFindPageResult([
        {
          ...
          starsCount: 1, forksCount: 0, language: null,
          htmlUrl: 'url', homepage: null,
          description: null, descriptionCn: null as string | null,
          readmeCn: longReadme, readmeOriginal: null,
        },
      ], 1))
      const res = createMockResponse()
      ...
      mockRepoService.findPage.mockResolvedValue(mockFindPageResult([
        {
          ...
          readmeCn: '中文README', readmeOriginal: '# Original',
        },
      ], 1))
      const res = createMockResponse()
      ...
      mockRepoService.findPage.mockResolvedValue(mockFindPageResult([
        {
          ...
          htmlUrl: 'url', homepage: null,
          description: null, descriptionCn: null,
          readmeCn: null, readmeOriginal: '# Original',
        },
      ], 1))
      const res = createMockResponse()
