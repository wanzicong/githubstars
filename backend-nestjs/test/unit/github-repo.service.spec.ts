  ...
  describe('upsertRepo', () => {
    it('应调用 $executeRaw 执行 INSERT ... ON DUPLICATE KEY UPDATE', async () => {
      await service.upsertRepo({
        repoName: 'test', fullName: 'owner/test', description: 'desc',
        language: 'TS', ownerName: 'owner', ownerAvatarUrl: 'url',
        htmlUrl: 'html', homepage: null, starsCount: 10, forksCount: 5,
        watchersCount: 3, openIssuesCount: 1, topics: '[]', licenseName: 'MIT',
        isFork: false, isArchived: false, repoCreatedAt: new Date(),
        repoUpdatedAt: new Date(), repoPushedAt: new Date(), starredAt: new Date(),
      })
