...
export const DOWNLOAD_MIRROR_SOURCES = [
    ...
    {
        name: 'gh-proxy-org',
        label: 'gh-proxy.org(CF v4)',
        url: 'https://gh-proxy.org',
        description: '主站加速，全球高速分发',
        keepProtocol: true,
    },
    {
        name: 'gh-proxy-v4',
        label: 'v4.gh-proxy.org',
        url: 'https://v4.gh-proxy.org',
        description: '优选加速，仅支持 IPv4',
        keepProtocol: true,
    },
    {
        name: 'gh-proxy-v6',
        label: 'v6.gh-proxy.org',
        url: 'https://v6.gh-proxy.org',
        description: '优选加速，支持 IPv4/IPv6',
        keepProtocol: true,
    },
    {
        name: 'gh-proxy-cdn',
        label: 'cdn.gh-proxy.org',
        url: 'https://cdn.gh-proxy.org',
        description: 'Fastly CDN 节点加速',
        keepProtocol: true,
    },
    {
        name: 'gitclone',
