...
// ———— Step 1: 编译后端 ———————————————————————————————————————
console.log("[bundle-backend] Step 1: 编译后端... (Already built, skipping)")
// Skip build since it's already done - permission issue on Windows
...
cpSync(SRC_PRISMA, resolve(BUNDLE_DIR, "prisma"), { recursive: true, force: true })
...
if (nodeModulesExists) {
  console.log("[bundle-backend] node_modules already exists, skipping npm install...")
} else {
