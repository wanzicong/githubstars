...
export default function AuthorDetail() {
    ...
    const handleExport = useCallback(async () => {
        ...
        try {
            ...
            a.href = url
            a.download = `stars_${ownerName}.txt`
        ...
        <div>
                ...
                <Card style={{ marginBottom: 20 }}>
                    <Row gutter={[24, 16]} align='middle'>
                        <Col xs={24} sm={4} style={{ textAlign: 'center' }}>
                            <Avatar src={authorStats.ownerAvatarUrl} alt={ownerName} size={80} style={{ border: '2px solid #f0f0f0' }} />
                        </Col>
                        <Col xs={24} sm={10}>
                        ...
                        <Col xs={8} sm={3}>
                            <Statistic title='仓库数' value={authorStats.repoCount} prefix={<GithubOutlined />} />
                        </Col>
                        <Col xs={8} sm={3}>
                            <Statistic
                                title='总 Star'
            ...
            <Card style={{ marginBottom: 20 }}>
                <Space size='middle'>
                    ...
                    <Select
                        ...
                        style={{ width: 100 }}
                    />
                    {authorStats && <Text type='secondary'>共 {authorStats.repoCount} 个仓库</Text>}
                </Space>
            </Card>
            ...
            <Spin spinning={loading}>
                {repos.length > 0 ? (
                    ...
                    <Card>
                        <Empty description={loading ? '加载中...' : `作者 ${ownerName} 暂无 Star 仓库`} />
                    </Card>
                )}
            </Spin>
